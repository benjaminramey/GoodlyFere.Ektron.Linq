...
// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EktronDecimalPropertyAttribute.cs">
...
{
    /// <summary>
    /// Use this attribute to designate a decimal-type metadata property.  This is a 
    /// convenience attribute for setting EktronExpressionType to
    /// typeof(DecimalPropertyExpression) on an <see cref="EktronPropertyAttribute"/>.
    /// </summary>
